...
_Static_assert(sizeof(struct bk7258_wifi_profile) == 100, "profile ABI");
_Static_assert(sizeof(struct bk7258_wifi_profile_request) == 104,
               "profile request ABI");
_Static_assert(sizeof(struct bk7258_wifi_profile_response) == 104,
